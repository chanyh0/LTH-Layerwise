...
CUDA_VISIBLE_DEVICES=6 nohup python -u main_imp_new.py --data datasets/cifar10 --dataset cifar10 --arch res50 --save_dir resnet50_cifar10_st_0.1 --init pretrained_model/simclr_weight.pt --resume --checkpoint LotteryTickets/cifar10_ST/11_checkpoint.pt --seed 1 --lr 0.1 --fc --rate 0.1 --pruning_times 15 > resnet50_cifar10_st_0.1.out &
