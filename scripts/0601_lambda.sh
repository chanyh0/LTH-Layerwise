...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.125 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.125_w20_IMP \
  --rewind_epoch 8 \
...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.15 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.15_w20_IMP \
  --rewind_epoch 8 \
...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.2 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.2_w20_IMP \
  --rewind_epoch 8 \
...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.4 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.4_w20_IMP \
  --rewind_epoch 8 \
...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.1 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.1_w20_IMP \
  --rewind_epoch 8 \
...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.075 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.075_w20_IMP \
  --rewind_epoch 8 \
...
--seed 1 --arch res50 --pruning_times 15 --rate 0.2 --prune_type lt  --epoch 160 --lr 0.05 --decreasing_lr 80,120 \
  --warmup 20  --batch_size 32 --save_dir res50_tiny-imagenet_b32_e160_lr0.05_w20_IMP \
  --rewind_epoch 8 \
