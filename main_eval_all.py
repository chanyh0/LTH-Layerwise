...
parser.add_argument('--type', type=str, default=None, choices=['ewp', 'random_path', 'betweenness', 'hessian_abs'])
...
def load_ticket(model, args):
    ...
    if args.mask_dir:
        ...
        custom_prune(model, current_mask, args.type, args.num_paths, args.conv1, args.add_back)
