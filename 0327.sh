...
CUDA_VISIBLE_DEVICES=2 nohup python -u main_imp_new.py --data datasets/cifar100 --dataset cifar100 --arch res18 --save_dir resnet18_cifar100_lt_0.2 --init pretrained_model/resnet18_lt.pt --seed 1 --lr 0.1 --fc --rate 0.2 --pruning_times 15 --prune_type rewind_lt > resnet18_cifar100_lt_0.2.out &
CUDA_VISIBLE_DEVICES=3 nohup python -u main_imp_new.py --data datasets/cifar100 --dataset cifar100 --arch res18 --save_dir resnet18_cifar100_pt_0.2 --init pretrained_model/resnet18_pt.pt --seed 1 --lr 0.1 --fc --rate 0.2 --pruning_times 15 > resnet18_cifar10_pt_0.2.out &